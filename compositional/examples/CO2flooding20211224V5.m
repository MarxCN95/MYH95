...
%%  ------------*************************-----多次循环--------**************-------
        ...
        pcapillary = 0 ;
        [wsb15, statesb15, repb15] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspcb15, statespcb15, reppcb15] = simulateScheduleAD(state0, model, schedule);
    ...
    %% ******************************------10----------*********
        ...
        pcswitch = 0;%PR-EOS考虑毛管力的开关
        pcapillary = 0 ;
        [wsb10, statesb10, repb10] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspcb10, statespcb10, reppcb10] = simulateScheduleAD(state0, model, schedule);
