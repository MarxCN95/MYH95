...
%%  ------------*************************-----多次循环--------**************-------
        ...
        pcapillary = 0 ;
        [ws15, states15, rep15] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspc15, statespc15, reppc15] = simulateScheduleAD(state0, model, schedule);
    ...
    %% ******************************------10----------*********
        ...
        pcswitch = 0;%PR-EOS考虑毛管力的开关
        pcapillary = 0 ;
        [ws10, states10, rep10] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspc10, statespc10, reppc10] = simulateScheduleAD(state0, model, schedule);
        ...
        pcswitch = 0;%PR-EOS考虑毛管力的开关
        pcapillary = 0 ;
        [ws20, states20, rep20] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspc20, statespc20, reppc20] = simulateScheduleAD(state0, model, schedule);
        ...
        pcswitch = 0;%PR-EOS考虑毛管力的开关
        pcapillary = 0 ;
        [ws50, states50, rep50] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspc50, statespc50, reppc50] = simulateScheduleAD(state0, model, schedule);
        ...
        pcswitch = 0;%PR-EOS考虑毛管力的开关
        pcapillary = 0 ;
        [ws0, states0, rep0] = simulateScheduleAD(state0, model, schedule);
        pcswitch = 1;%PR-EOS考虑毛管力的开关
        pcapillary = 500 ;
        [wspc100, statespc100, reppc100] = simulateScheduleAD(state0, model, schedule);
