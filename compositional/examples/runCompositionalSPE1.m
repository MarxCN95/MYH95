...
% %%
% model3d = NaturalVariablesCompositionalModel(G, rock, flowfluid, fluid, 'water', false);
% T = 150 + 273.15;
% eos = initDeckEOSModel(deck);
% p = 75*barsa;
% state0 = initCompositionalState(G, minP + (maxP - minP)/2, T, [0.5, 0.5], info.initial, eos3d);
% [ws, states, rep] = simulateScheduleAD(state0, model3d, schedule);
